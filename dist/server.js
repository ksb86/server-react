...
server.get('/', function (req, res) {
    ...
    var title = 'React Server Rendering';
    ...
    var cssPath =  false ? './server-react.1.0.0.min.css' : './styles.css';
    var jsPath =  false ? './server-react.1.0.0.min.js' : './client.js';
...
server.listen(port, function () {
    console.log('Listening on port ' + port + ' @ ' + (0, _momentTimezone2.default)().tz('America/Boise').format('MMM DD, YYYY - hh:mm:ssa') + ' (mt)');
});
